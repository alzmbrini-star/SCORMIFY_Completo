...
- **[DONE]** Fix nginx startup failure in production ARM64 - /app/fix_nginx_modules.sh removes broken module symlinks and replaces nginx-code-server.conf with Lua-free version when Lua .so files are missing
