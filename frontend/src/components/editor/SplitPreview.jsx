  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900" data-testid="split-preview">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Slide area */}
        <div ref={slideWrapperRef} className="flex-1 flex items-center justify-center p-3 overflow-hidden">
          <div
                ...
                <div key={element.id} className="absolute" style={{
                  ...
                  {element.type === 'video' && (
                    <div className="w-full h-full rounded overflow-hidden" style={{ background: 'transparent' }}>
                      {element.embedUrl ? (
                        <iframe src={getAssetUrl(element.embedUrl, projectId)} className="w-full h-full border-0" style={{ background: 'transparent' }} allow="autoplay; fullscreen" title="Video" />
                      ) : element.src ? (
