                    ...
                    slide.elements.forEach(function(elem, elemIndex) {{
                        ...
                        if (elem.type === 'text') {{
                            ...
                            if (isFullDoc) {{
                                ...
                                if (isGameElement && wrappedHtml.indexOf('__scormify_game_fit_v7') === -1) {{
                                    var gameFit = '<style id="__scormify_game_fit_v7">html,body{{margin:0!important;padding:0!important;width:100%!important;height:100%!important;overflow:hidden!important;}}#__stage{{width:960px!important;height:540px!important;min-width:960px!important;min-height:540px!important;max-width:none!important;max-height:none!important;transform-origin:0 0!important;}}</style>' +
                                        '<scr' + 'ipt>(function(){{function f(){{var st=document.getElementById("__stage")||document.querySelector("main.app,main.game,.app,.game");if(!st)return;var p=2,s=Math.max(.1,Math.min((innerWidth-p*2)/960,(innerHeight-p*2)/540)),x=(innerWidth-960*s)/2,y=(innerHeight-540*s)/2;st.style.setProperty("width","960px","important");st.style.setProperty("height","540px","important");st.style.setProperty("transform-origin","0 0","important");st.style.setProperty("transform","translate("+x+"px,"+y+"px) scale("+s+")","important");}}addEventListener("resize",f);f();var n=0,t=setInterval(function(){{f();if(++n>=24)clearInterval(t)}},100);}})();</scr' + 'ipt>';
