...
def _build_game_fallback_html(sb_slide: dict, bank_questions: list | None = None) -> str:
    ...
    stage_profiles = {
        "penalty_quest": '<div class="arena penalty-stage" id="arena"><div class="crowd"></div><div class="goal"></div><div id="keeper" class="keeper">🧤</div><div id="ball" class="ball">⚽</div><div class="stage-caption">Converta conhecimento em gols</div></div>',
        "quiz_show": '<div class="arena quiz-stage" id="arena"><div class="spotlight left"></div><div class="spotlight right"></div><div class="podium"><i>2</i><i>1</i><i>3</i></div><div id="keeper" class="keeper">👏</div><div id="ball" class="ball">🎤</div><div class="stage-caption">Responda antes que as luzes se apaguem</div></div>',
        "memory_match": '<div class="arena memory-stage" id="arena"><div class="memory-grid"><i>?</i><i>🧠</i><i>?</i><i>💡</i><i>?</i><i>⭐</i><i>?</i><i>🎯</i></div><div id="keeper" class="keeper">COMBINE</div><div id="ball" class="ball">✨</div><div class="stage-caption">Ative pares e fortaleça as conexões</div></div>',
        "knowledge_climb": '<div class="arena climb-stage" id="arena"><div class="mountain"></div><div class="checkpoints"><i></i><i></i><i></i><i></i><i></i></div><div id="keeper" class="keeper">🏆</div><div id="ball" class="ball">🧗</div><div class="stage-caption">Cada acerto leva você mais perto do cume</div></div>',
        ...
        "word_challenge": '''<div class="arena word-stage" id="arena" style="background:linear-gradient(135deg,#eff6ff,#dbeafe);color:#172033;border-color:#93c5fd;display:grid;grid-template-columns:38% 62%;align-items:center;padding:18px 28px;gap:22px">
        ...
        "target_challenge": '<div class="arena target-stage" id="arena"><div class="target-rings"><b>100</b></div><div id="keeper" class="keeper">PRECISÃO</div><div id="ball" class="ball">➤</div><div class="stage-caption">Analise, escolha e acerte o centro</div></div>',
    }
