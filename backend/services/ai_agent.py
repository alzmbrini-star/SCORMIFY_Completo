        ...
        "word_challenge": '''<div class="arena word-stage" id="arena" style="background:linear-gradient(135deg,#eff6ff,#dbeafe);color:#172033;border-color:#93c5fd;display:grid;grid-template-columns:38% 62%;align-items:center;padding:18px 28px;gap:22px">
          <div class="word-illustration" style="height:205px;border-radius:20px;background:#fff;box-shadow:0 12px 28px #1e3a5f24;display:grid;place-items:center">
            <svg viewBox="0 0 260 190" role="img" aria-label="Forca educativa" style="width:92%;height:92%;display:block">
              ...
              <circle cx="172" cy="86" r="18" fill="#fef2f2" stroke="#ef4444" stroke-width="6"/>
              <path d="M172 104V140M172 116L146 129M172 116L198 129M172 140L151 163M172 140L194 163" fill="none" stroke="#ef4444" stroke-width="6" stroke-linecap="round"/>
          ...
          <div class="word-board" style="min-width:0;text-align:center">
            <div style="font-size:12px;font-weight:900;letter-spacing:.16em;color:#4338ca;margin-bottom:12px">FORCA INTELIGENTE</div>
            <div class="word-slots" aria-label="Palavra secreta" style="position:static;display:flex;justify-content:center;gap:8px;margin:0 0 18px">
              <i style="width:34px;height:40px;border-bottom:4px solid #4f46e5"></i><i style="width:34px;height:40px;border-bottom:4px solid #4f46e5"></i><i style="width:34px;height:40px;border-bottom:4px solid #4f46e5"></i><i style="width:34px;height:40px;border-bottom:4px solid #4f46e5"></i><i style="width:34px;height:40px;border-bottom:4px solid #4f46e5"></i><i style="width:34px;height:40px;border-bottom:4px solid #4f46e5"></i>
            </div>
            <div class="letter-preview" style="display:grid;grid-template-columns:repeat(7,32px);justify-content:center;gap:6px">
              <span>A</span><span>E</span><span>I</span><span>O</span><span>U</span><span>R</span><span>S</span><span>T</span><span>L</span><span>M</span><span>N</span><span>P</span><span>C</span><span>D</span>
            </div>
            <p style="margin:13px 0 0;color:#475569;font-size:12px;font-weight:700">Use a pergunta como dica e descubra o conceito.</p>
          </div>
