...
def _build_game_fallback_html(sb_slide: dict, bank_questions: list | None = None) -> str:
    ...
    stage_profiles = {
        ...
        "word_challenge": '<div class="arena word-stage" id="arena"><div class="gallows"><b></b><i></i><em></em></div><div class="word-slots"><i></i><i></i><i></i><i></i><i></i><i></i></div><div id="keeper" class="keeper">DICA</div><div id="ball" class="ball">✏️</div><div class="stage-caption">Descubra o conceito antes de completar o desenho</div></div>',
