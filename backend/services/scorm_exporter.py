...
<head>
    ...
    <style>
        * {{
        ...
        /* Mobile portrait mode - BLOCKED by orientation overlay */
        ...
        /* Portrait mode is blocked by orientation overlay */
        
        /* === MOBILE LANDSCAPE REFLOW MODE === */
        body.mobile-landscape-reflow #slide-container {{
        ...
        body.mobile-landscape-reflow .slide-element {{
            position: relative !important;
            left: auto !important;
            top: auto !important;
            width: 100% !important;
        ...
        body.mobile-landscape-reflow .slide-element.video-element {{
            height: auto !important;
            aspect-ratio: 16 / 9;
            max-height: 60vh;
        }}
        
        body.mobile-landscape-reflow .slide-element.video-element iframe {{
            width: 100% !important;
            height: 100% !important;
        }}
        
        body.mobile-landscape-reflow .slide-element img {{
            max-width: 100% !important;
            height: auto !important;
        }}
        
        body.mobile-landscape-reflow .slide-element.quiz-element {{
            height: auto !important;
            min-height: 200px;
        }}
        
        body.mobile-landscape-reflow #slide-wrapper {{
            align-items: flex-start !important;
        ...
        body.mobile-landscape-reflow .slide-bg {{
            display: none !important;
        }}
